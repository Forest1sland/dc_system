...
public class CollectorController {
    ...
    public ResultModel<Collector> loginCollector(@RequestBody Collector model) throws BusinessException {
        Collector result = collectorService.loginCollector(model.getTel(), model.getPassword());
